...
def gen_label_for_json(args, image_set, instance_level_label):
    ...
    with open(json_path) as f:
        # This loop iterates through each image as each json line represents an image
        for line in f:
            ...
            # This line iterates through each lane in the label data
            ...
            # This code actually writes the lane data to image by connecting each one of the points given by the original label data with a line 
...
def generate_label(args):
    instance_level_label = False
    if (args.instance_level == 'y' or args.instance_level == 'Y'):
        instance_level_label = True
    ...
    gen_label_for_json(args, 'train_val', instance_level_label)
    print("generating test set...")
    gen_label_for_json(args, 'test', instance_level_label)
