...
class iouEval:
    """
    IoU or intersection over union is a metric for measuring success in image segmentation tasks. Is calculated by dividing the area of intersection
    of the truth label and the prediciton and the area of the union of the prediciton and the truth label
    """
